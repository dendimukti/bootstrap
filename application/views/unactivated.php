...
<html lang="en">
  <head>
    <meta charset="utf-8">
    <title>Activation Account is not Complete</title>
    ...
    <div class="http-error">
        <div class="http-error-message">
            ...
            <div class="error-message">
                <p>This Account Registration is not Complete.
				Please, Activate Your Email First<p>
                <p class="return-home"><a href="<?php echo base_url();?>app/logout">Log Out</a></p>
            </div>
        </div>
    </div>
</div>
